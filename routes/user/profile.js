...
var routes = function (router) {
    router.put('/user/profile/', authHelper.ensureAuthenticated, function (req, res) {
        ...
        if (requiredFields.dateOfBirth) {
            req.checkBody('dateOfBirth', req.__('BACK_PROFILE_UPDATE_DATE_OF_BIRTH_EMPTY_OR_INVALID')).notEmpty().isInt();
        } else if (req.body.dateOfBirth) {
            req.checkBody('dateOfBirth', req.__('BACK_PROFILE_UPDATE_DATE_OF_BIRTH_EMPTY_OR_INVALID')).isInt();
        }
