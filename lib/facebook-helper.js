...
function fbDateOfBirthToTimestamp(fbDateOfBirth) {
    ...
    logger.info('[FacebookHelper][fbDateOfBirthToTimestamp]Parsing date of birth: ' + fbDateOfBirth);
    console.log('[FacebookHelper][fbDateOfBirthToTimestamp]Parsing date of birth: ' + fbDateOfBirth);
