...
// redirect jquery
app.use('/js', express.static(__dirname + '/' + urlPrefix + '/../node_modules/jquery/dist'));
app.use('/jquery-form', express.static(__dirname + '/' + urlPrefix + '/../node_modules/jquery-form'));
app.use('/cookie', express.static(__dirname + '/' + urlPrefix + '/../node_modules/js-cookie'));
// redirect bootstrap
app.use('/bootstrap', express.static(__dirname + '/' + urlPrefix + '/../node_modules/bootstrap'));
// redirect bootstrap datepicker
app.use('/bootstrap-datepicker', express.static(__dirname + '/' + urlPrefix + '/../node_modules/bootstrap-datepicker'));
// redirect public files
app.use('/assets', express.static(__dirname + '/' + urlPrefix + '/../public'));
