...
function performLogin(profile, providerName, done) {
    db.SocialLogin.findOne({where: {uid: profile.provider_uid}}).then(function (provider) {
        var me, user;
        if (!provider) {
            db.User.findOrCreate({
                ...
                me = _me;
                return fillProfile(me, profile.first_name, profile.last_name, profile.gender, profile.birthday);
            }).then(function () {
