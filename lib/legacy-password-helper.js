...
function createBTQHash(password, saltByte) {
...
function checkLegacyPassBTQ(passwordToCheck, hash, btqHash) {
    ...
    var saltByte = new Buffer(2);
    decodedHash.copy(saltByte, 0, decodedHash.length - 2);
    return createBTQHash(passwordToCheck, saltByte) === btqHash;
}
